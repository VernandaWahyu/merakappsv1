    ...
    <div class="authentication-inner">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form id="formAuthentication" class="mb-3" action="/auth/create" method="post">
            @csrf
            <div class="mb-3">
              <label for="name" class="form-label">Username</label>
              <input type="text" class="form-control" id="name" value="{{ Session::get('name') }}"
            ...
            <button class="btn btn-primary d-grid w-100" name="submit" type="submit">
              Sign Up
            </button>
          </form>
